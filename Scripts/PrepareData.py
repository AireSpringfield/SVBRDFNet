...
params_global['envMapFolder'] = r'../Training Set/EnvMap'


with open(params_global['envMapFolder'] + r'/light.txt', 'r') as f:
     lightID = list(map(int, f.read().strip().split('\n')))
...
if __name__ == '__main__':
    ...
    data_root = root_path + r'/Training Set'
    data_tag = 'plastic'
    out_root = data_root
    ...
    lightPool = pickle.load(open(lightpool_file, 'rb'), encoding = 'latin1')
